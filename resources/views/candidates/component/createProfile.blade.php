...
<div class="modal animated zoomIn" id="createProfile-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
async function updatebyID(id) {
    ...
    async function fillUpUpdateForm(id) {
        try {
            console.log(id);
            showLoader();
            let res = await axios.post( "/candidates/ProfileById", {id:id }, HeaderToken());
            hideLoader();
    ...
    async function UpdateProfile() {
        console.log("hello i am updateProfile");
try {
