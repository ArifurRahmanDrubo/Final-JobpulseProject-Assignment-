...
<body>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="profile-img">
                        <img id="previewImage" src="{{ asset($adminProfile->profile_image) }}" alt=""/>
                ...
                <div class="col-md-3">
                    <input type="hidden" name="id" id="updateProfileid" value="{{ $adminProfile->id }}">
                    <button type="button" onclick="updatebyID({{ $adminProfile->id }})" data-bs-toggle="modal" data-bs-target="#createProfile-modal" class="float-end profilebtn m-0 btn">Edit Profile</button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-5">
                    <div class="tab-content profile-tab" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="social" role="tabpanel" aria-labelledby="social-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ $adminProfile->facebook }}"><label><i class="fab fa-facebook"></i> Facebook</label></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ $adminProfile->twitter }}"><label><i class="fab fa-twitter"></i> Twitter</label></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ $adminProfile->linkedin }}"><label><i class="fab fa-linkedin"></i> Linkedin</label></a>
                                </div>
                            </div>
                        </div>
    ...
    @include('admin.component.createProfile')
    ...
    async function storeImage() {
        try {
            ...
            console.log(formData);
                ...
                let res = await axios.post("/admin/img/create", formData, HeaderToken());
